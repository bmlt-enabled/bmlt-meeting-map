...
if (!class_exists("BMLTMeetingMap")) {
	class BMLTMeetingMap {
		var $optionsName = 'bmlt_meeting_map_options';
		var $options = array();
...
.onoffswitch-inner:after {
    ...
    text-align: left;
		...
		function getAllMeetings($root_server, $query_string) {
		...
		function getAllFormats($root_server,$lang_enum) {
		    $ch = curl_init();
